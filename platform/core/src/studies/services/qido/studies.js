...
function resultDataToStudies(resultData) {
  ...
  resultData.forEach(study =>
    studies.push({
      ...
      // // 00081190 = URL
      // PatientName: study.patient.patient_name,
      // PatientID: study.patient.patient_id,
      // PatientBirthdate: study.patient.patient_birthdate,
      // patientSex: study.patient.patient_sex,
      // studyId: study.patient.patient_age,
      // numberOfStudyRelatedSeries: study.series.length,
      // numberOfStudyRelatedInstances: study.images_count,
